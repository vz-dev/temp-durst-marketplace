...
// ---------- Yves host
$config[ApplicationConstants::HOST_YVES] = 'www.stage02.durst.shop';
...
// ---------- Zed host
$config[ApplicationConstants::HOST_ZED] = 'fridge.stage02.durst.shop';
...
// ---------- Propel
$config[PropelConstants::ZED_DB_DATABASE] = 'DE_staging_zed';
...
// ---------- RabbitMQ
$config[RabbitMqConstants::RABBITMQ_USERNAME] = 'spryker';
$config[RabbitMqConstants::RABBITMQ_VIRTUAL_HOST] = '/durst_platform';
