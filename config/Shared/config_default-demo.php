...
$config[KernelConstants::STORE_PREFIX] = 'DEMO';
...
$config[SetupConstants::JENKINS_DIRECTORY] = '/data/shop/demo/shared/data/common/jenkins';
...
// media
$config[AppRestApiConstants::UPLOAD_BRANCH_FOLDER_HOST] = 'https://haendler.demo.durst.shop';
...
// ---------- Mail
$config[MailConstants::MAIL_MERCHANT_CENTER_BASE_URL] = 'https://haendler.demo.durst.shop';
$config[MailConstants::MAIL_CANCEL_ORDER_BASE_URL] = 'https://customer.demo.durst.shop/cancel-order/cancel?t=%s';

// ---------- Campaign setting, copied from AppRestApi
$config[CampaignConstants::DEEP_LINK_URL] = 'https://www.webshop-demo.durst.shop/start?branchCode=%s&productSku=%s';
