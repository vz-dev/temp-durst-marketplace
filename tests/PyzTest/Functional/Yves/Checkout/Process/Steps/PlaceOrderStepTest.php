...
class PlaceOrderStepTest extends Unit
{
     ...
     * @param MockObject|\Spryker\Yves\Messenger\FlashMessenger\FlashMessengerInterface|null $flashMessengerMock
     *
    ...
    /**
     * @return MockObject|\Spryker\Client\Checkout\CheckoutClientInterface
     */
