...
namespace PyzTest\Acceptance\Yves\Availability\Presentation;

use PyzTest\Acceptance\Yves\Availability\AvailabilityPresentationTester;
use PyzTest\Acceptance\Yves\Cart\PageObject\CartListPage;
use PyzTest\Acceptance\Yves\Product\PageObject\ProductDetailPage;
use PyzTest\Acceptance\Zed\Availability\PageObject\AvailabilityViewPage;
use PyzTest\Acceptance\Zed\Sales\PageObject\OrderDetailPage;
use PyzTest\Acceptance\Zed\Sales\PageObject\OrderListPage;
...
class CheckoutAvailabilityCest
{
     ...
     * @skip
     *
     * @param \PyzTest\Acceptance\Yves\Availability\AvailabilityPresentationTester $i
     *
     * @return void
     */
