...
namespace PyzTest\Acceptance\Zed\ProductRelation\Presentation;

use PyzTest\Acceptance\Zed\ProductRelation\PageObject\ProductRelationCreatePage;
use PyzTest\Acceptance\Zed\ProductRelation\ProductRelationPresentationTester;
...
class ProductRelationCreateRelationCest
{
     ...
     * @skip
     *
     * @param \PyzTest\Acceptance\Zed\ProductRelation\ProductRelationPresentationTester $i
     *
     * @return void
     */
