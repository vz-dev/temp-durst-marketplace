...
class CheckoutControllerProvider extends AbstractYvesControllerProvider
{
    ...
    const CHECKOUT_BRANCH = 'checkout-branch';
    const CHECKOUT_CONCRETETIMESLOT = 'checkout-concrete-timeslot';
    ...
    protected function defineControllers(Application $app)
    {
        ...
        $this->createController('/{checkout}/branch', self::CHECKOUT_BRANCH, 'Checkout', 'Checkout', 'branch')
            ->assert('checkout', $allowedLocalesPattern . 'checkout|checkout')
            ->value('checkout', 'checkout')
            ->method('GET|POST');

        $this->createController('/{checkout}/concrete-timeslot', self::CHECKOUT_CONCRETETIMESLOT, 'Checkout', 'Checkout', 'concreteTimeSlot')
            ->assert('checkout', $allowedLocalesPattern . 'checkout|checkout')
            ->value('checkout', 'checkout')
            ->method('GET|POST');
