...
class BranchSelectionStep extends AbstractBaseStep implements StepWithBreadcrumbInterface
{
    /**
    ...
    {
        if(false === $this->isBranchInQuote($dataTransfer)){
            return false;
        }
    ...
    protected function isBranchInQuote(QuoteTransfer $quoteTransfer)
    {
        return $quoteTransfer->getFkBranch() !== null;
    }
