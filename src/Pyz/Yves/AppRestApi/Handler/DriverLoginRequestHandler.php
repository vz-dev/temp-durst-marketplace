...
class DriverLoginRequestHandler implements RequestHandlerInterface
{
    ...
    /**
     * DriverLoginRequestHandler constructor.
    ...
    public function handleJson(string $json, string $version = 'v1'): stdClass
    {
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverLoginRequestSchemaPath()
            );
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverLoginResponseSchemaPath()
            );
