...
class DriverDepositRequestHandler implements RequestHandlerInterface
{
    ...
    /**
     * DriverDepositRequestHandler constructor.
    ...
    public function handleJson(string $json, string $version = 'v1'): stdClass
    {
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverDepositRequestSchemaPath()
            );
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverDepositResponseSchemaPath()
            );
