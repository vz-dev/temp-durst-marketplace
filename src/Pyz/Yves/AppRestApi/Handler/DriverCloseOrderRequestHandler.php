...
class DriverCloseOrderRequestHandler implements RequestHandlerInterface
{
    ...
    /**
     * DriverCloseOrderRequestHandler constructor.
     *
    ...
    public function handleJson(string $json, string $version = 'v1'): stdClass
    {
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverCloseOrderRequestSchemaPath()
            );
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverCloseOrderResponseSchemaPath()
            );
