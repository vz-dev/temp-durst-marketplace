...
class DriverTourRequestHandler implements RequestHandlerInterface
{
    ...
    /**
     * DriverTourRequestHandler constructor.
    ...
    public function handleJson(string $json, string $version = 'v1'): stdClass
    {
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverTourRequestSchemaPath()
            );
        ...
        $this
            ->validate(
                ...
                $this
                    ->config
                    ->getDriverTourResponseSchemaPath()
            );
