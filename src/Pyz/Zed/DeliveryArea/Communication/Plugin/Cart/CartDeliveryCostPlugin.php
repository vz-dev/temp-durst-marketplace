<?php
/**
 * Durst - project - CartDeliveryCostPlugin.php.
 *
 * Initial version by:
...
/**
 * Class CartDeliveryCostPlugin
 * @package Pyz\Zed\DeliveryArea\Communication\Plugin\Cart
 * @method DeliveryAreaFacadeInterface getFacade()
 */
class CartDeliveryCostPlugin extends AbstractPlugin implements ItemExpanderPluginInterface
{
    /**
