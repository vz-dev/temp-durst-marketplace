<?php
/**
 * Durst - project - CustomerDecline.php.
 *
 * Initial version by:
 ...
 */
class MarkDamage extends AbstractCommand implements CommandByItemInterface
{
    public const EVENT_ID = 'markDamage';
    public const NAME = 'WholesaleOrder/MarkDamage';
    public const STATE_NAME = 'mark damaged';
