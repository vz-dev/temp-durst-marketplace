<?php
/**
 * Durst - project - IsMissing * Initial version by:
 ...
 */
class IsMissing extends AbstractPlugin implements ConditionInterface
{
    public const NAME = 'Wholesale/IsMissing';
    ...
    {
        return $orderItem->getDeliveryStatus() === SalesConstants::ORDER_ITEM_DELIVERY_STATUS_MISSING;
    }
}
