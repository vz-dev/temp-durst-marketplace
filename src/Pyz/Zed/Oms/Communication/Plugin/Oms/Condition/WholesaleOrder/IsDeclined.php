<?php
/**
 * Durst - project - IsDeclined.phpInitial version by:
 ...
 */
class IsDeclined extends AbstractPlugin implements ConditionInterface
{
    public const NAME = 'Wholesale/IsDeclined';
    ...
    {
        return $orderItem->getDeliveryStatus() === SalesConstants::ORDER_ITEM_DELIVERY_STATUS_DECLINED;
    }
}
