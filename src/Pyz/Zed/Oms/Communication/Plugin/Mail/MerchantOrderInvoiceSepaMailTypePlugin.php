...
class MerchantOrderInvoiceSepaMailTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    const MAIL_TYPE = 'merchant order invoice sepa mail';
    ...
    {
        $mailBuilder->setHtmlTemplate('oms/mail/merchant-order-invoice-sepa-mail.html.twig');
    ...
    {
        $mailBuilder->setTextTemplate('oms/mail/merchant-order-invoice-sepa-mail.text.twig');
