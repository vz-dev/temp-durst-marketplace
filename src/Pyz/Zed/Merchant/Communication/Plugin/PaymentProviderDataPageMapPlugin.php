...
/**
 * Class PaymentProviderDataPageMapPlugin
 * @package Pyz\Zed\Merchant\Communication\Plugin
 *
 * @method MerchantFacadeInterface getFacade()
 */
class PaymentProviderDataPageMapPlugin extends AbstractPlugin implements PageMapInterface
{
    /**
     * @api
     *
    ...
    public function buildPageMap(PageMapBuilderInterface $pageMapBuilder, array $data, LocaleTransfer $locale) : PageMapTransfer
    {
        return $this
            ->getFacade()
            ->buildPaymentProviderPageMap($pageMapBuilder, $data, $locale);
    }
}
