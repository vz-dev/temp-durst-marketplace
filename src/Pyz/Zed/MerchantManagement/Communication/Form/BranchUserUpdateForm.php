<?php
/**
 * Durst - project - BranchUserUpdateForm.php.
 *
 * Initial version by:
...
class BranchUserUpdateForm extends AbstractType
{
    public const OPTION_SALUTATION_OPTIONS = 'OPTION_SALUTATION_OPTIONS';
    public const OPTION_BRANCH_OPTIONS = 'OPTION_BRANCH_OPTIONS';
    public const OPTION_ACL_GROUPS = 'OPTION_ACL_GROUPS';

    public const FIELD_BRANCH = 'fkBranch';
    ...
    protected const LABEL_BRANCH = 'Branch';
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver
            ->setDefaults(
                [
                    'data_class' => BranchUserTransfer::class,
                    'csrf_token_id' => 'branch_user_update_form'
                ]
            );
    }
    ...
    protected function addBranchField(FormBuilderInterface $builder, array $options): self
    {
        $builder
            ->add(
                ...
                ChoiceType::class,
                [
                    'choices' => $options[static::OPTION_BRANCH_OPTIONS],
                    'label' => static::LABEL_BRANCH
                ]
            );
