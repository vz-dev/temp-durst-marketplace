<?php
/**
 * Durst - project - HasValidOrders.php.
 *
 * Initial version by:
...
/**
 * Class HasValidOrders
 * @package Pyz\Zed\Tour\Communication\Plugin\Condition
 * @method TourFacadeInterface getFacade()
 */
class HasValidOrders extends AbstractPlugin implements ConditionPluginInterface
{
    public const CONDITION_NAME = 'WholesaleTour/HasValidOrders';
