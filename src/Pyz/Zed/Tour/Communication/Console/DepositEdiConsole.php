...
/**
 * Class DepositEdiConsole
 * @package Pyz\Zed\Tour\Communication\Console
 * @method TourFacadeInterface getFacade()
 */
class DepositEdiConsole extends Console
{
    public const COMMAND_NAME = 'deposit:edi:export';
    protected const COMMAND_DESCRIPTION = 'Creates an EDI deposit export and uploads it to path / URL.';
