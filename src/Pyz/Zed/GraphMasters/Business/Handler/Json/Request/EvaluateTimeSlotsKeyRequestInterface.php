...
class EvaluateTimeSlotsKeyRequestInterface
{
    public const IMPORT_ORDER_KEY = 'order';
    ...
    public const EVALUTE_TIME_SLOTS_KEY = 'timeSlots';
    ...
    public const EVALUTE_TIME_SLOTS_KEY_SLOT_SIZE_SMALL = 'small';
    public const EVALUTE_TIME_SLOTS_KEY_SLOT_SIZE_MEDIUM = 'medium';
    public const EVALUTE_TIME_SLOTS_KEY_SLOT_SIZE_LARGE= 'large';
}
