<?php
/**
 * Durst - project - RealaxFixedExportConsole.php.
 *
 * Initial version by:
...
/**
 * Class RealaxFixedExportConsole
 * @package Pyz\Zed\Accounting\Communication\Console
 * @method \Pyz\Zed\Accounting\Business\AccountingFacadeInterface getFacade()
 */
class RealaxExportFixedConsole extends Console
{
    public const COMMAND_NAME = 'realax:invoice:export:fix';
    protected const COMMAND_DESCRIPTION = 'Creates a CSV file in the Realax format with all fixed values for the given merchant or for all merchants to the (optional) given path.';
