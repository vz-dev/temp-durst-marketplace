<?php
/**
 * Durst - project - RealaxExportFixedOutputStream.php.
 *
 * Initial version by:
...
class RealaxExportFixedOutputStream implements StreamInterface, WriteStreamInterface
{
    protected const REALAX_MAIL_SUBJECT = 'Lizenzrechnung (fix) %s';
    protected const REALAX_MAIL_MESSAGE = 'Das System hat die Lizenzrechnung (fix) %s erstellt.';
