<?php
/**
 * Durst - project - RealaxExporFixedtInputStream.php.
 *
 * Initial version by:
...
class RealaxExportFixedInputStream implements StreamInterface, ReadStreamInterface
{
    /**
     * @var int
     */
    ...
    public function open(): bool
    {
        $realaxTransfer = $this
            ->facade
            ->getRealaxFixedTransferByIdMerchant(
                $this
                    ->idMerchant
            );
