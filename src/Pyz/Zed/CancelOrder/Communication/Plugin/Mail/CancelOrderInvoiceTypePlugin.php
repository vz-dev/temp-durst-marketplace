<?php
/**
 * Durst - project - CancelOrderInvoiceTypePlugin.php.
 *
 * Initial version by:
...
class CancelOrderInvoiceTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    public const MAIL_TYPE = 'cancel order with invoice payment';
    ...
    {
        $mailBuilder->setHtmlTemplate('cancel-order/mail/cancel-order-invoice.html.twig');
    ...
    {
        $mailBuilder->setTextTemplate('cancel-order/mail/cancel-order-invoice.text.twig');
