<?php
/**
 * Durst - project - CancelOrderCreditCardTypePlugin.php.
 *
 * Initial version by:
...
class CancelOrderCreditCardTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    public const MAIL_TYPE = 'cancel order with credit card payment';
    ...
    {
        $mailBuilder->setHtmlTemplate('cancel-order/mail/cancel-order-credit-card.html.twig');
    ...
    {
        $mailBuilder->setTextTemplate('cancel-order/mail/cancel-order-credit-card.text.twig');
