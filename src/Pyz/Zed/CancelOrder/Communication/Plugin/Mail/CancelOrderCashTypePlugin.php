<?php
/**
 * Durst - project - CancelOrderCashTypePlugin.php.
 *
 * Initial version by:
...
class CancelOrderCashTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    public const MAIL_TYPE = 'cancel order with cash payment';
    ...
    {
        $mailBuilder->setHtmlTemplate('cancel-order/mail/cancel-order-cash.html.twig');
    ...
    {
        $mailBuilder->setTextTemplate('cancel-order/mail/cancel-order-cash.text.twig');
