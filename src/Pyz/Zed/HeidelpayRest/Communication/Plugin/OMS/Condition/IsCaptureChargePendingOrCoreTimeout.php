<?php
/**
 * Durst - project - IsCaptureChargePendingOrCoreTimeout.php.
 *
 * Initial version by:
...
/**
 * Class IsCaptureChargePendingOrCoreTimeout
 ...
 */
class IsCaptureChargePendingOrCoreTimeout extends AbstractPlugin implements ConditionInterface
{
    public const NAME = 'HeidelpayRest/IsCaptureChargePendingOrCoreTimeout';
