...
$projectData['_pipeline'] = $projectData['pipeline'];
...
$projectData['_syncMerchantCenterSessionName'] = preg_replace('/[^-a-zA-Z0-9]/', '-', $projectData['namespace'] . '-merchant_center-' . $projectData['tag'] . '-codebase');
